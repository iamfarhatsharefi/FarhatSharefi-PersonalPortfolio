...
I am constantly <span class="highlight">eager</span> to expand my knowledge and skills. Beyond coding, I am enthusiastic about collaborating with others and sharing knowledge. I believe in the power of teamwork and am always open to new ideas and perspectives. My goal is to not only build functional and aesthetically pleasing web applications but also to make a positive impact through my work.`;
...
document.addEventListener('DOMContentLoaded', () => {
  const aboutContent = {
   ...
   I thrive on collaboration and am always excited to join forces on projects that challenge and inspire. My mission is to blend cutting-edge technology with artistic flair to create impactful solutions that resonate with users and leave a lasting impression.
    ...
    certifications: [
      { title: 'Responsive Web Design', image: 'images/1 certificate.png', link: 'https://link-to-1 certificate' },
      { title: 'Java Script', image: 'images/2 certificate.png', link: 'https://link-to-2 certificate' },
    ],
  };
...
document.addEventListener('DOMContentLoaded', () => {
  const projects = [
    ...
    },
    {
      ...
      screenshots: ['images/Picture1.png'],
      technologies: ['HTML', 'CSS', 'JS'],
    ...
    },
    {
      ...
      screenshots: ['images/Picture3.png', 'images/N2.png'],
      technologies: ['HTML', 'CSS', 'JS'],
    ...
    },
    {
      ...
      screenshots: ['images/Picture4 cash register.png', 'images/C2.png'],
      technologies: ['HTML', 'CSS', 'JS'],
    ...
    },
    {
      ...
      screenshots: ['images/picture 5.png', 'images/PO2.png'],
      technologies: ['HTML', 'CSS', 'JS'],
